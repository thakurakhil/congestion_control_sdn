...
awk '{p=index($3,".") ; print (substr($3,0,p-1))(",")($7) }' < iperf_pcc_0.txt | head -n -7 | tail -n+4 > iperf_csv_pcc_0.txt
awk '{p=index($3,".") ; print (substr($3,0,p-1))(",")($7) }' < iperf_pcc_1.txt | head -n -7 | tail -n+4 > iperf_csv_pcc_1.txt
awk '{p=index($3,".") ; print (substr($3,0,p-1))(",")($7) }' < iperf_pcc_2.txt | head -n -7 | tail -n+4 > iperf_csv_pcc_2.txt
awk '{p=index($3,".") ; print (substr($3,0,p-1))(",")($7) }' < iperf_pcc_3.txt | head -n -7 | tail -n+4 > iperf_csv_pcc_3.txt
