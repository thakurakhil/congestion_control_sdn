...
class SimpleSwitch(app_manager.RyuApp):
    ...
    def getswitchports(self, dpid):
        ...
        p = subprocess.Popen("sudo ovs-ofctl dump-ports-desc s1 | grep '[0-9](' | awk 'BEGIN { FS = \")\" } ; { print $1 }' |  awk 'BEGIN { FS = \"(\" } ; { print $1,$2 }'", shell=True, stdout=subprocess.PIPE)
        ...
        for port in self.port_num_to_name[dpid]:
            ...
            print str1 
            p = subprocess.Popen("sudo %s" % str1, shell=True, stdout=subprocess.PIPE)
